...
ActiveRecord::Schema.define(version: 20170716082629) do
  ...
  create_table "assets", id: :uuid, default: -> { "uuid_generate_v4()" }, force: :cascade do |t|
    ...
    t.uuid "creator_id"
    t.index ["site_id", "creator_id"], name: "index_assets_on_site_id_and_creator_id"
    t.index ["site_id", "slug"], name: "idx_assets_slugs", unique: true
  ...
  create_table "categories", id: :uuid, default: -> { "uuid_generate_v4()" }, force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["site_id", "slug"], name: "index_categories_on_site_id_and_slug"
  end
  ...
  create_table "contents", id: :uuid, default: -> { "uuid_generate_v4()" }, force: :cascade do |t|
    ...
    t.index ["site_id", "type", "status"], name: "index_contents_on_site_id_and_type_and_status"
  end
  ...
  create_table "drafts", id: :uuid, default: -> { "uuid_generate_v4()" }, force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["content_id"], name: "index_drafts_on_content_id"
  end
  ...
  create_table "extension_configs", id: :uuid, default: -> { "uuid_generate_v4()" }, force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["name", "site_id"], name: "index_extension_configs_on_name_and_site_id", unique: true
    t.index ["site_id"], name: "index_extension_configs_on_site_id"
  end
  ...
  create_table "fulltext_indices", id: :uuid, default: -> { "uuid_generate_v4()" }, force: :cascade do |t|
    ...
    t.tsvector "tsv"
    t.uuid "site_id", null: false
    t.index ["published"], name: "index_fulltext_indices_on_published"
    t.index ["searchable_id", "published"], name: "fulltext_indices_searchable_unique_idx", unique: true
    t.index ["site_id", "searchable_type"], name: "index_fulltext_indices_on_site_id_and_searchable_type"
    t.index ["tsv"], name: "fulltext_tsv_idx", using: :gin
  end

  create_table "memento_sessions", id: :serial, force: :cascade do |t|
    t.uuid "user_id"
    t.string "undo_info"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "memento_states", id: :serial, force: :cascade do |t|
  ...
  create_table "permalinks", id: :uuid, default: -> { "uuid_generate_v4()" }, force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["site_id", "path"], name: "index_permalinks_on_site_and_path", unique: true
  end
  ...
  create_table "request_logs", id: :uuid, default: -> { "uuid_generate_v4()" }, force: :cascade do |t|
    ...
    t.index ["device_class"], name: "request_logs_device_class_idx"
    t.index ["processed", "resource_type"], name: "index_request_logs_on_processed_and_resource_type"
    t.index ["site_id", "resource_type", "resource_id"], name: "request_logs_site_id_resource_type_resource_id_idx"
  end
  ...
  create_table "sites", id: :uuid, default: -> { "uuid_generate_v4()" }, force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index "lower((hostname)::text)", name: "index_sites_hostname", unique: true
  ...
  create_table "stats_pageviews", id: :uuid, default: -> { "uuid_generate_v4()" }, force: :cascade do |t|
    ...
    t.index ["site_id", "date", "content_id"], name: "index_stats_pageviews_on_site_id_and_date_and_content_id"
    t.index ["stats_visit_id"], name: "idx_stats_pageviews_visit_id"
  end
  ...
  create_table "stats_visits", id: :uuid, default: -> { "uuid_generate_v4()" }, force: :cascade do |t|
    ...
    t.integer "length"
    t.index ["site_id", "date", "mobile"], name: "index_stats_visits_on_site_id_and_date_and_mobile"
  end
  ...
  create_table "tags", id: :uuid, default: -> { "uuid_generate_v4()" }, force: :cascade do |t|
    ...
    t.index ["site_id", "slug"], name: "index_tags_on_site_and_slug", unique: true
  end

  create_table "unread_items", id: :serial, force: :cascade do |t|
    t.uuid "user_id"
    t.string "item_type"
    t.uuid "item_id"
    t.uuid "site_id"
  ...
  create_table "visitor_postings", id: :uuid, default: -> { "uuid_generate_v4()" }, force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.datetime "deleted_at"
    t.index ["site_id", "type", "content_id"], name: "index_visitor_postings_on_site_id_and_type_and_content_id"
    t.index ["status"], name: "index_visitor_postings_on_status"
  end
