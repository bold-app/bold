...
(function() {
  ...
  Vim.defineEx('write', 'w', function(context) {
    // the Save command is defined in bold/editor.js.coffee
    context.ace.execCommand('Save');
  });
  Vim.defineEx('wp', null, function(context) {
    context.ace.execCommand('SaveAndPublish');
  });
  Vim.defineEx('wq', null, function(context) {
    context.ace.execCommand('SaveAndQuit');
  });
  Vim.defineEx('wpq', null, function(context) {
    context.ace.execCommand('SaveAndPublishAndQuit');
  });
  defaultKeymap.push(
